...
permutationPlot(y)
legend('pos 2', 'pos 3', 'RAN')
legend boxoff
%%
Blue   = [0.00 0.45 0.74];
Orange = [0.85 0.33 0.10];
Yellow = [0.93 0.69 0.13];
function permutationPlot(y)
    hold on, box off
    h = plot(y') ;
    set(h, {'Color'}, {[1 0 0]; [0 0 1]; [0 0 0]}) ;
...
%         plot([off off],  [-50 100],  ':r')
        set(gca, 'XTick',      [ 30 45 60] );
        set(gca, 'XTickLabel', [ 150 300 450]);
