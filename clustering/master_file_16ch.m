...
pathToYourConfigFile = 'C:\Users\u0105250\Documents\GitHub\KiloSort'; % take from Github folder and put it somewhere else (together with the master_file)
run(fullfile(pathToYourConfigFile, 'config_file_16ch.m')) 
