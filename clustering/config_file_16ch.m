%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Based on C:\Users\u0105250\Documents\MATLAB\KiloSort\configFiles\StandardConfig_MOVEME.m
% Adjusted by Els Crijns on 18-07-2018
% optimized for the rat set-up, assuming 32 channels
% Settings can be adjusted for each recording session to allow optiomal
% clustering quality
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
ops.fbinary             = fullfile(fpath, 'chunk.dat'); % default: chunk.dat ; will be created for 'openEphys'		
ops.fproc               = fullfile(fpath, 'temp_wh.dat'); % residual from RAM of preprocessed data, will be created		
ops.root                = fpath; % 'openEphys' only: where raw files are		

ops.fs                  = 32556;        % sampling rate default rats: 32556		(omit if already in chanMap file)
...
ops.chanMap             = 'C:\Users\u0105250\Documents\MATLAB\Sequence Learning\clustering\16edge_chanMap.mat'; % make this file using createChannelMapFile.m		
...
%% additional options
% ops.nt0           = 61;       %number of datapoints included in waiveform 